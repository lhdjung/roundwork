...
#'   not meant to replace it. Their purpose is to reconstruct the computations
#'   of researchers who might have used different software. See
...
#'   ([`reround()`]'s default, `rounding = "up_or_down"`, spans the results of
...
#'   spelled out separately. [`round_ties_to_away()`] and friends give some of
#'   them their official IEEE 754 names.
#'
