...
Alternatively, a function that uses `unround()` as a helper might count decimal places by itself. It should then pass these numbers to `unround()` via the `digits` argument instead of letting it redundantly count decimal places a second time.
