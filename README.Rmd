...
"Up" and "down" mean up and down *on the number line*, so they only part company with "away from zero" and "toward zero" below zero. If you would rather not have to keep that straight, name the tie-breaking rule outright:
